...
(In case you're curious, the statistical relationship isn't significant either in a linear model, as we'd expect (*b = `r first_letter_lm$estimate[2]`, p = `r first_letter_lm$p.value[2]`*).)
