...
We might be interested in phrases that follow specific words like "use" or "don't use". Here we ask for evertyhing after `word` and up until the first period.
