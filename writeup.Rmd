...
We need to get within-document counts of each word. We'll also count how often the word is used in all reviews
...
A question we might be interested in is: which words are most distinctive to each category?
